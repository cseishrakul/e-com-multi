                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="zoom-area">
                        <img id="zoom-pro" class="img-fluid"
                            src="{{ asset('admin/photos/product_images/large/' . $productDetails['product_image']) }}"
                            data-zoom-image="{{ asset('admin/photos/product_images/large/' . $productDetails['product_image']) }}">
                        <div id="gallery" class="u-s-m-t-10">
                            <a class="active"
                                data-image="{{ asset('admin/photos/product_images/large/' . $productDetails['product_image']) }}"
                                data-zoom-image="{{ asset('admin/photos/product_images/large/' . $productDetails['product_image']) }}">
                            ...
                            @foreach ($productDetails['images'] as $image)
                                <a data-image="{{ asset('admin/photos/product_images/large/' . $image['image']) }}"
                                    data-zoom-image="{{ asset('admin/photos/product_images/large/' . $image['image']) }}">
                                    <img src="{{ asset('admin/photos/product_images/large/' . $image['image']) }}"
                                        alt="Product">
                                </a>
                            @endforeach
                        </div>
                        ...
                        <div class="section-6-social-media-quantity-actions u-s-p-y-14">
                            <form action="#" class="post-form">
                                ...
                                <div class="quantity-wrapper u-s-m-b-22">
                                    <span>Quantity:</span>
                                    <div class="quantity">
                                        <input type="number" name="quantity" id="" class="quantity-text-field" value="1">
                                    </div>
                                </div>
                                <div>
                                ...
                                <div class="description-whole-container">
                                    @if ($productDetails['product_video'])
                                        <video width="320" height="240" controls>
                                            <source src="{{url('admin/videos/product_video/'.$productDetails['product_video'])}}" type="video/mp4">
                                        </video>
                                    @else
