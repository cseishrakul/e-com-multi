                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="thumbnails" style="margin-top: 30px">
                        <a href="{{ asset('admin/photos/product_images/large/' . $productDetails['product_image']) }}"
                            ...
                            <img width="120" height="120" src="{{ asset('admin/photos/product_images/small/' . $productDetails['product_image']) }}"
                                alt="" />
                        </a>
                        ...
                        @foreach ($productDetails['images'] as $image)
                            <a href="{{ asset('admin/photos/product_images/large/' . $image['image']) }}"
                                ...
                                <img width="120" height="120" src="{{ asset('admin/photos/product_images/small/' . $image['image']) }}"
                                    alt="" />
                            </a>
                        @endforeach
                    </div>
