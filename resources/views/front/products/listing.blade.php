        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                    ...
                    @if (isset($_GET['sort']))
                        <div class=""> {{$categoryProducts->appends(['sort'=>$_GET['sort']])->links()}} </div>
                    @else
                        <div class=""> {{$categoryProducts->links()}} </div>
                    @endif
                    
                    <!-- Row-of-Product-Container /- -->
                    <div class="mt-3">{{ $categoryDetails['categoryDetails']['description'] }}</div>
                </div>
                <!-- Shop-Right-Wrapper /- -->
                <!-- Shop-Pagination -->
