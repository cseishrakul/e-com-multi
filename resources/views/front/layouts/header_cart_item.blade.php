...
<div class="mini-cart-wrapper">
    <div class="mini-cart">
            ...
            @foreach ($getCartItems as $item)
                ...
                <li class="clearfix">
                    <a href="{{ url('product/' . $item['product_id']) }}">
                        ...
                        <span class="mini-item-price">{{ $getDiscountAttributePrice['final_price'] }} Tk.</span>
        ...
        <div class="mini-shop-total clearfix">
            ...
            <span class="mini-total-price float-right">{{ $total_price }} Tk.</span>
        </div>
        <div class="mini-action-anchors">
            <a href="{{ url('cart') }}" class="cart-anchor">View Cart</a>
            <a href="{{ url('cart') }}" class="checkout-anchor">Checkout</a>
        </div>
    </div>
</div>
<!-- Mini Cart /- -->
